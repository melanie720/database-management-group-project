...
The full up-down script creates our tables, inserts the initial data, and creates the data logic using functions, triggers, and procedures.

Also included is a demo file where you can test out the database's functionality and see a few user stories in action.
